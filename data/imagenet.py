...
class ImageNet:
    def __init__(self, args):
        ...
        indices = np.random.choice(len(train_dataset), args.num_samples_for_calib)
        self.calib_dataset = torch.utils.data.Subset(train_dataset, indices)
        
        self.train_loader = torch.utils.data.DataLoader(
            train_dataset, batch_size=args.batch_size, shuffle=True, **kwargs
        )
        self.calib_loader = torch.utils.data.DataLoader(
            self.calib_dataset, batch_size=args.batch_size, shuffle=True, **kwargs)
        ...
        indices = np.random.choice(len(val_dataset), args.num_samples_for_bn)
        val_calib_dataset = torch.utils.data.Subset(val_dataset, indices)
        
        self.val_calib_dataloader = torch.utils.data.DataLoader(
        val_calib_dataset, batch_size=args.batch_size, shuffle=True, **kwargs)
